...
def start_emission_tracker(online=False, *decargs, **deckwargs):
    def start_emission_tracker_decorator(func):
        def wrapper(*args, **kwargs):
            ...
            self.__emission_tracker__ = codecarbon_cls(measure_power_secs=measure_power_secs,tracking_mode=tracking_mode,log_level=log_level,*decargs, **deckwargs)
